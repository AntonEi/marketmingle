...
- Used on the main page, liked page, feed page, and profile page for loading the posts.
...
- Used in profile-related components to display user avatars such as for popular profiles, author of the post, and author of the comment.
...
**Usage:**
- Used in forms where tagging functionality is required, in this project it is used for creating or editing posts.
...
**Usage:**
- Used in for displaying a menu for posts and comments, to provide edit and delete functionality.
...
**Usage:**
- Rendered within the comment section of posts where comments are displayed.
...
**Usage:**
- Used in the comment section of posts to allow users to add new comments.
- Reused whenever there's a need for comment creation functionality, in this project on the post page *(PostPage.js)*.
...
#### PostPage.js
**Description:**
The PostPage component displays a single post along with its comments. Users can view the post content, comments, and interact by adding new comments.

**Usage:**
- Rendered when users navigate to view a specific post.
- Displays the post content, comments, and provides functionality to add new comments.
- Utilizes the Post and Comment components to render post details and comments.

#### PostsPage.js
**Description:**
The PostsPage component displays a list of Posts and provides search functionality to filter Posts based on user input. It also includes pagination for fetching more Posts.

**Usage:**
- Rendered on the main page for browsing posts.
- Allows users to search for specific posts based on keywords.
- Displays a list of posts, with the ability to load more posts dynamically.
- Utilizes the Post component to render individual Posts in the list.

#### Post.js
**Description:**
The Post component displays details of a single post, including its title, content, owner information *(Avatar.js)*, likes, comments, and tags. It also provides options for editing and deleting the post *(MoreDropdown.js)*.

**Usage:**
- Used on the PostPage and PostsPage to render individual Posts.
- Allows users to interact with posts by viewing, editing, or deleting them.
- Provides functionality to like posts and view comments associated with the post.

#### PostCreateForm.js
**Description:**
The PostCreateForm component provides a form for users to create a new post. It includes input fields for title, content, and tags *(FormTagsField.js)*.

**Usage:**
- Rendered when users want to create a new post.
- Allows users to input title, content, and tags for the new post.
- Provides form validation and error handling for input fields.

#### PostEditForm.js
**Description:**
The PostEditForm component renders a form for editing an existing post. It includes input fields for updating the post's title, content, and tags.

**Usage:**
- Rendered when users want to edit an existing post.
- Displays current post details for editing.
- Provides form validation and error handling for input fields.
...
#### ProfilePage
**Description:**
The ProfilePage component serves as the page for displaying user profiles, including profile information and associated posts.
